...
import com.github.rezalotfi01.bwallet.data.db.WalletRecordView
...
import com.github.rezalotfi01.bwallet.ui.qrdialog.QrDialog
import com.github.rezalotfi01.bwallet.utils.convertDpToPixel
import com.github.rezalotfi01.bwallet.utils.format
import com.github.rezalotfi01.bwallet.utils.sathoshiToBTCstring
...
//        viewModel.initViewModel("1r8JvHjYFiFDNdrDBW1iqDp8pmoaWuSaz") // Lot of transactions
        ...
        viewModel.walletDetail.observe(this, Observer walletRecordObserver@{
            ...
            textFinalBalanceCrypto.text = sathoshiToBTCstring(it?.finalBalance
                    ?: 0)
            textTotalReceived.text = sathoshiToBTCstring(it?.totalReceived
                    ?: 0)
            textTotalSent.text = sathoshiToBTCstring(it?.totalSent
                    ?: 0)
